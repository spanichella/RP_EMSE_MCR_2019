...
* 	(1) Shorten the method using Fowler's Extract Method, by finding parts
...
* 	This smell represents 46.88% of all found problems in the project with
...
public class FlexibleStringExpanderTests extends TestCase {
    ...
    class FseTestData {
      ...
      public final FlexibleStringExpander fse;
      ...
      public FseTestData(String label, String input, FlexibleStringExpander fse, Map<String, Object> context, TimeZone timeZone, Locale locale, String compare, Object expand, boolean isEmpty) {
        this.label = label;
        this.input = input;
        this.fse = fse;
    ...
    private static void doFseTestInput(FseTestData d) {
        assertEquals("isEmpty:" + d.label, d.isEmpty, d.fse.isEmpty());
        if (d.input == null) {
            assertEquals("getOriginal():" + d.label, "", d.fse.getOriginal());
            assertEquals("toString():" + d.label, "", d.fse.toString());
            assertEquals("expandString(null):" + d.label, "", d.fse.expandString(null));
            assertEquals("expand(null):" + d.label, null, d.fse.expand(null));
            if (d.timeZone == null) {
                assertEquals("expandString(null):" + d.label, "", d.fse.expandString(null, d.locale));
                assertEquals("expand(null):" + d.label, null, d.fse.expand(null, d.locale));
            } else {
                assertEquals("expandString(null):" + d.label, "", d.fse.expandString(null, d.timeZone, d.locale));
                assertEquals("expand(null):" + d.label, null, d.fse.expand(null, d.timeZone, d.locale));
            }
        } else {
            assertEquals("getOriginal():" + d.label, d.input, d.fse.getOriginal());
            assertEquals("toString():" + d.label, d.input, d.fse.toString());
            assertEquals("expandString(null):" + d.label, d.input, d.fse.expandString(null));
            assertEquals("expand(null):" + d.label, null, d.fse.expand(null));
            if (d.timeZone == null) {
                assertEquals("expandString(null):" + d.label, d.input, d.fse.expandString(null, d.locale));
                assertEquals("expand(null):" + d.label, null, d.fse.expand(null, d.locale));
            } else {
                assertEquals("expandString(null):" + d.label, d.input, d.fse.expandString(null, d.timeZone, d.locale));
                assertEquals("expand(null):" + d.label, null, d.fse.expand(null, d.timeZone, d.locale));
            }
        }
    }

    private static void doFseTestLocale(FseTestData d) {
        if (d.locale == null) {
            assertEquals(d.label, d.compare, d.fse.expandString(d.context));
            assertEquals("expand:" + d.label, d.expand, d.fse.expand(d.context));
        } else {
            Locale defaultLocale = Locale.getDefault();
            TimeZone defaultTimeZone = TimeZone.getDefault();
            try {
                Locale.setDefault(d.locale);
                TimeZone.setDefault(d.timeZone);
                assertEquals(d.label, d.compare, d.fse.expandString(d.context, null, null));
                assertEquals(d.label, d.expand, d.fse.expand(d.context, null, null));
                Locale.setDefault(badLocale);
                TimeZone.setDefault(badTimeZone);
                assertNotSame(d.label, d.compare, d.fse.expandString(d.context, null, null));
                if (d.input != null) {
                    assertNotSame(d.label, d.expand, d.fse.expand(d.context, null, null));
                }
                Map<String, Object> autoUserLogin = new  HashMap<String, Object>();
                autoUserLogin.put("lastLocale", d.locale.toString());
                autoUserLogin.put("lastTimeZone", d.timeZone == null ? null : d.timeZone.getID());
                d.context.put("autoUserLogin", autoUserLogin);
                assertEquals(d.label, d.compare, d.fse.expandString(d.context, null, null));
                assertEquals(d.label, d.expand, d.fse.expand(d.context, null, null));
                ...
                d.context.remove("autoUserLogin");
                d.context.put("locale", d.locale);
                d.context.put("timeZone", d.timeZone);
                assertEquals(d.label, d.compare, d.fse.expandString(d.context, null, null));
                assertEquals(d.label, d.expand, d.fse.expand(d.context, null, null));
                d.context.put("locale", badLocale);
                d.context.put("timeZone", badTimeZone);
                assertNotSame(d.label, d.compare, d.fse.expandString(d.context, null, null));
                if (d.input != null) {
                    assertNotSame(d.label, d.expand, d.fse.expand(d.context, null, null));
                }
                d.context.remove("locale");
                d.context.remove("timeZone");
                assertEquals(d.label, d.compare, d.fse.expandString(d.context, d.timeZone, d.locale));
                assertEquals(d.label, d.expand, d.fse.expand(d.context, d.timeZone, d.locale));
                assertNotSame(d.label, d.compare, d.fse.expandString(d.context, badTimeZone, badLocale));
                if (d.input != null) {
                    assertNotSame(d.label, d.expand, d.fse.expand(d.context, badTimeZone, badLocale));
                }
            } finally {
    ...
    private static void doFseTest(FseTestData d) {
      doFseTestInput(d);
      doFseTestLocale(d);
    }
