...
* -	This test contains a method (fmaTest) that requires a large amount of parameters.
...
* -	This test contains a method (fmaTest) that does too many things at once. This
...
public class FlexibleMapAccessorTests extends GenericTestCaseBase {
	 ...
	 *   that should be passed to a method is 6.0. The parameters are String, String, etc..
