...
* -	This test contains a method (testJSONToMap(), testJSONToList()) that checks several methods of 
...
* 	This smell represents 28.12% of all found problems in the project with
* 	22.22% occurring in this test.
**/
public class TestJSONConverterswithDescription extends TestCase {
    ...
    /**
	 * - This test method checks  number of methods of the class being tested,
	 * .00 percentage of all methods of the original class.
	 * The called methods are (cast, toMap, from, convert, getConverter, put).
	 *   Apply (0) Extract Method to improve it.
	 * - This setUp fixture is too general. 
	 *   Apply (1) to improve the test.
	 */
    ...
    /**
	 * - This test method checks  number of methods of the class being tested,	 * .00 percentage of all methods of the original class.	 * The called methods are (add, cast, from, toList, convert, getConverter).	 *   Apply (0) Extract Method to improve it.	 * - This setUp fixture is too general. 	 *   Apply (1) to improve the test.
	 */
