...
* -	This test contains a method (doFseTest) that requires a large amount of parameters.
...
* -	This test contains a method (doFseTest) that does too many things at once. This
...
public class FlexibleStringExpanderTests extends TestCase {
    ...
    /**
	 * - This method contains 9.0 parameters. These are too many. The maximum number of parameters
