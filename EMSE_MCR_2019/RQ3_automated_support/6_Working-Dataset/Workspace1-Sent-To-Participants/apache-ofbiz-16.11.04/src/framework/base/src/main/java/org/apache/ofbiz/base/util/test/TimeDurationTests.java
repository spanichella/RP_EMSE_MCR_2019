...
* -	This test contains a method (assertDurationFields) that requires a large amount of parameters.
...
* -	This test contains a method (assertDurationLoop) that does too many things at once. This
...
public class TimeDurationTests extends GenericTestCaseBase {
    ...
    /**
	 * - This method contains 12.0 parameters. These are too many. The maximum number of parameters
	 *   that should be passed to a method is 6.0. The parameters are String, int, etc..
