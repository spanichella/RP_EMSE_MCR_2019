...
* -	This test contains a method that does too many things at once. This
* 	makes the code hard to understand and maintain. 
* 	(0) Shorten the method using Fowler's Extract Method, by finding parts
* 	of the method that go together and extracting them to new methods.
* 	This method accounts for 100.00% of all found problems in this test class.
* 	This smell represents 44.12% of all found problems in the project with
* 	6.67% occurring in this test.
**/
public class EntityQueryTestSuitewithDescription extends EntityTestCase {
     ...
     */
    /**
	 * - This method does too many things at once.	 * - This method has 427.0 Lines of Code. It shouldn't be more than 626.5 lines of code.	 *   Improve it by applying (0).
	 */
